...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 12, 0]
    },
    _AsyncCompleter: {
    ...
    HttpRequest_request: function(url, method, mimeType, onProgress, requestHeaders, responseType, sendData, withCredentials) {
      ...
      t1 = [W.ProgressEvent];
      new W._EventStreamSubscription(0, xhr, "load", W._wrapZone(new W.HttpRequest_request_closure0(completer, xhr)), false, t1)._tryResume$0();
    ...
    ImmutableListMixin: {
      "^": "Object;$ti",
      get$iterator: function(receiver) {
        return new W.FixedSizeListIterator(receiver, receiver.length, -1, null);
      },
      $isList: 1,
      $asList: null,
      $isEfficientLengthIterable: 1,
    ...
    sendReceive: function() {
      var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, mapData;
      var $async$sendReceive = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              mapData = new H.JsLinkedHashMap(0, null, null, null, null, null, 0, [null, null]);
              mapData.$indexSet(0, "name", "Cesar");
              mapData.$indexSet(0, "car", "BMW");
              $async$goto = 2;
              return P._asyncHelper(W.HttpRequest_request("receivejson", "POST", null, null, null, null, C.JsonCodec_null_null.encode$1(mapData), null).then$1(new F.sendReceive_closure()), $async$sendReceive, $async$completer);
            case 2:
      ...
      return P._asyncHelper(null, $async$sendReceive, $async$completer);
    },
    postForm: function() {
      var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, mapData;
      var $async$postForm = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              mapData.$indexSet(0, "car", "BMW");
              $async$goto = 2;
              return P._asyncHelper(W.HttpRequest_postFormData("receivepost", mapData, null, null, null, null).then$1(new F.postForm_closure()), $async$postForm, $async$completer);
            case 2:
              // returning from await.
              // implicit return
              return P._asyncHelper(null, 0, $async$completer);
      ...
      return P._asyncHelper(null, $async$postForm, $async$completer);
    },
    getData: function() {
      var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, model, t1, t2, $async$temp1;
      var $async$getData = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return P._asyncHelper(W.HttpRequest_getString("https://jsonplaceholder.typicode.com/users", null, null), $async$getData, $async$completer);
            case 2:
              // returning from await.
              model = $async$temp1.decode$1($async$result);
              t1 = document;
              t2 = J.getInterceptor$asx(model);
              t1.querySelector("#divc").textContent = J.$index$asx(t2.$index(model, 0), "name");
              if (t1.querySelectorAll("#outputB").length !== 0)
                t1.querySelector("#outputB").textContent = J.$index$asx(t2.$index(model, 1), "name");
              t1.querySelector("#divd").textContent = J.$index$asx(t2.$index(model, 2), "name");
              // implicit return
              return P._asyncHelper(null, 0, $async$completer);
            case 1:
              // rethrow
      ...
      return P._asyncHelper(null, $async$getData, $async$completer);
    },
    main: [function() {
      var t1, t2;
      F.getData();
      t1 = document;
      t2 = J.get$onClick$x(t1.querySelector("#darta"));
      new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.main_closure()), false, [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = J.get$onClick$x(t1.querySelector("#dartb"));
      new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0()), false, [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$0", "main__main$closure", 0, 0, 1],
    sendReceive_closure: {
      "^": "Closure:4;",
      call$1: function(resp) {
        document.querySelector("#divc").textContent = J.toString$0$(J.get$response$x(resp));
        P.print(J.toString$0$(W._convertNativeToDart_XHR_Response(resp.response)));
      }
    },
    postForm_closure: {
      "^": "Closure:4;",
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, args: [,,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}];
